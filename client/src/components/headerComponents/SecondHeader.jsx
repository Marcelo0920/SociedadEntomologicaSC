...
import '../../styles/components/SecondHeader.css';

const SecondHeader = ({auth: {isAuthenticated, loading}, logout}) =>
{
...
return(
    <header className="header-inicio-1"> 
...
export default connect(mapStateToProps, {logout})(SecondHeader);